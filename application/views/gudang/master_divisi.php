    ...
    <div class="container mt-5">
        ...
        <div class="pd-20 card-box mb-30 mx-auto" style="max-width: 800px;">
            ...
            <table class="data-table table nowrap">
                <thead>
                    <tr>
                        <th class="table-plus">Nama Divisi</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="inputModalLabel">Tambah Nama Divisi</h5>
                    ...
                    <div class="modal-body">
                        <form id="inputForm">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" id="namaDivisi" name="namaDivisi[]" type="text"
